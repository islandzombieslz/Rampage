...
required=[
    ...
    "e.clan='water';e.hp=e.maxHp=550;e.shield=e.maxShield=150;e.damage=75;",
    "e.clan='water';e.hp=e.maxHp=150;e.shield=e.maxShield=summonerId===null?100:0;e.damage=25;",
    "const SEAHORSE_NORMAL_MS=1050;",
    "const POSEIDON_MELEE_ATTACKS_PER_CYCLE=6;",
    "const POSEIDON_SUMMON_COUNT=3;",
    "e.poseidonWaveGoal=3;",
    "function xpRequiredForLevel(",
    "function showWarGoalToast(",
    ...
    "return Math.min(2.15,Math.max(w/state.world.w,h/state.world.h));",
